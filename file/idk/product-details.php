									...
									<div class="col-12 col-lg-7">
										<div class="product-info-section p-3">
											...
											<div class="d-flex align-items-center mt-3 gap-2">
												...
												<h4 class="mb-0">Rs. <?php echo $product['price']; ?></h4>
											</div>
											<div class="mt-3">
												<h6>Discription :</h6>
						...
						<div class="product-more-info">
							...
							<div class="tab-content pt-3">
								...
								<div class="tab-pane fade" id="more-info" role="tabpanel">
									<h3>General</h3>
									<ul>
										<li class="col-3-12">In The Box -- &emsp; Handset, Adaptor (15W), Charging Cable, Sim Ejector Pin, User Manual</li>
										<li>Model Number --&emsp; SM-E225FZKDINS</li>
										<li>Model Name --&emsp; Galaxy F22</li>
										<li>Color --&emsp; Denim Black</li>
										<li>Browse Type --&emsp; Smartphones</li>
										<li>SIM Type --&emsp; Dual Sim</li>
										<li>Hybrid Sim Slot --&emsp; No</li>
										<li>Touchscreen --&emsp; Yes</li>
										<li>OTG Compatible --&emsp; Yes</li>
									</ul>
								</div>
																...
																<div class="d-flex align-items-start">
																	...
																	<div class="review-content ms-3 col-12">
																		...
																		<div class="d-flex align-items-center mb-2">
																			<h6 class="mb-0 col-10"><?php echo $reviews[$i]['firstname']; echo " ",$reviews[$i]['lastname']; ?></h6>
										...
										<div class="card-body">
											<div class="product-info">
												...
												<div class="product-action mt-2">
													<div class="d-grid gap-2">
														<a href="javascript:;" class="btn btn-dark btn-ecomm"> <i class='bx bxs-cart-add'></i>Add to Cart</a> 
														<a href="javascript:;" class="btn btn-light btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class='bx bx-zoom-in'></i>Quick View</a>													</div>
												</div>
											</div>
										</div>
									</div>
