												...
												<div class="border p-3">
													...
													<div class="form-body">
														<form class="row g-3">
															...
															<div class="col-md-6">
																<div class="d-grid">	<a href="shop-cart.php" class="btn btn-light btn-ecomm"><i class='bx bx-chevron-left'></i>Back to Cart</a>
																</div>
															</div>
															<div class="col-md-6">
																<div class="d-grid">	<a href="checkout-shipping.php" class="btn btn-dark btn-ecomm">Proceed to Checkout<i class='bx bx-chevron-right'></i></a>
																</div>
															</div>
														</form>
													</div>
