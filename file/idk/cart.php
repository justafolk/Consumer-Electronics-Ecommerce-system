					...
					<div class="product-grid py-4" id="Trending">
						<div class="container">
							...
							<div class="d-flex align-items-center mt-3">
								<h5 class="text-uppercase mb-0">Total Value: <?php echo $Total_Price; ?></h5>
								<a href="shop-cart.php" class="btn btn-dark btn-ecomm ms-auto rounded-0 border-1">CheckOut<i class='bx bx-chevron-right'></i></a>
							</div>
							<hr class="mt-3">
						</div>
					</div>
