            ...
            <section class="py-4">
                <div class="container">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <h4 class=""><?php  echo str_replace("_", " ", $_POST["firstname"]) ?></h4>
                                        <?php 
                                        $ad = $_POST["address1"];
                    ...
                    <?php  
                        ...
                        $sql = "insert into OrderDB ( invoice, amount, c_id, Prod_id,Order_date, Order_status) values('".$_POST["txnid"]."',".$_POST["amount"].",'".$user_id."','".$products."','".$_POST["addedon"]."','Placed')";
                        $result = mysqli_query($conn, $sql);
