									...
									<div class="card-body">
										...
										<div class="product-categories">
											...
											<ul class="list-unstyled mb-0 categories-list">
												<li><a href="javascript:;">Mobiles <span class="float-end badge rounded-pill bg-primary">42</span></a>
												</li>
												<li><a href="javascript:;">Laptops <span class="float-end badge rounded-pill bg-primary">32</span></a>
												</li>
												<li><a href="javascript:;">MacBooks <span class="float-end badge rounded-pill bg-primary">17</span></a>
												</li>
												<li><a href="javascript:;">Televisions <span class="float-end badge rounded-pill bg-primary">217</span></a>
												</li>
												<li><a href="javascript:;">Lighting <span class="float-end badge rounded-pill bg-primary">28</span></a>
												</li>
												<li><a href="javascript:;">ShoesSmart Watch <span class="float-end badge rounded-pill bg-primary">145</span></a>
												</li>
												<li><a href="javascript:;">Galaxy Phones <span class="float-end badge rounded-pill bg-primary">15</span></a>
												</li>
												<li><a href="javascript:;">PC Monitors <span class="float-end badge rounded-pill bg-primary">8</span></a>
												</li>
											</ul>
										</div>
										<hr>
						...
						<div class="col-12 col-xl-9">
							<div class="product-wrapper">
								...
								<div class="product-grid">
									...
									$sql = "SELECT * FROM productdb WHERE (title LIKE '%{$_GET['term']}%' or Tags LIKE '%{$_GET['term']}%' or specification LIKE '%{$_GET['term']}%' or category LIKE '%{$_GET['term']}%')  LIMIT 5";
